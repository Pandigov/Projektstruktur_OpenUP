...
Dieses Visions-Dokument bezieht sich auf den Online-Cocktailversand, das von <Team> entwickelt wird. Das System wird es Barbesitzer erlauben, das Online Coktail Bestellsystem  zu betreiben, eigene Kundenkontos verwalten, verschiedene Bezahlmöglichkeiten zur Verfügung stellen,  um damit Bestellvorgänge zu erleichtern.
...
[cols="1,3"]
|===
| Das Problem | geringe Reichweite und eingeschränktes Eingehen auf Kundenbedürfnisse
| betrifft | Kunden, Mitarbeiter, Barbesitzer, Lieferanten, Staat
| die Auswirkung davon ist | , dass der Kunde nur vor Ort Cocktails kaufen kann
| eine erfolgreiche Lösung wäre | große Reichweite und Eingehen auf Kundenbedürfnisse, Umsatzerhöhung
|===
...
| Kunden
| Privatkunden
| Bestellungen über das System aufgeben. Zusammenstellung von Cocktails
|Barbetreiber/Onlineshopbesitzer
|Besitzer des Systems
|Verwaltung Mitarbeiter, Kontrolle
|===
